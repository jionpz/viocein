...
impl PipelineHandle {
    ...
    fn set_state(&self, new_state: PipelineState) {
        ...
        if let Some(tray_handle) = self.app_handle.try_state::<crate::TrayHandle>() {
            let tooltip = match new_state {
                PipelineState::Preparing => "viocein - Preparing...",
                PipelineState::Recording => "viocein - Recording...",
                PipelineState::Transcribing => "viocein - Transcribing...",
                PipelineState::Polishing => "viocein - Polishing...",
                PipelineState::Outputting => "viocein - Outputting...",
                PipelineState::AskRecording => "viocein - Ask...",
                PipelineState::AskThinking => "viocein - Answering...",
                PipelineState::Idle => "viocein",
            };
    ...
    pub async fn stop(&self) -> Result<()> {
        ...
        if let Some(tray_handle) = self.app_handle.try_state::<crate::TrayHandle>() {
            if let Ok(t) = tray_handle.tray.lock() {
                let _ = t.set_tooltip(Some("viocein - Transcribing..."));
            }
        }
        crate::refresh_tray(&self.app_handle);
